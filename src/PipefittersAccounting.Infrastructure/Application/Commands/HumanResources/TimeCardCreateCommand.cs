...
{
    public class TimeCardCreateCommand : WriteCommandHandler<TimeCardWriteModel,
                                                             IEmployeeAggregateRepository,
                                                             IEmployeeAggregateValidationService,
                                                             Employee>
    {
        public TimeCardCreateCommand
        (
        ...
        {
            return await ValidationService.IsValidCreateTimeCardInfo(WriteModel);
        }
