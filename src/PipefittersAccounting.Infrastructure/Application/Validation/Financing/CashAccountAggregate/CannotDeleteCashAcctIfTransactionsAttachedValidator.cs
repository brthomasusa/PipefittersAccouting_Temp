...
{
    public class CannotDeleteCashAcctIfTransactionsAttachedValidator : Validator<DeleteCashAccountInfo>
    {
        private readonly ICashAccountQueryService _cashAcctQrySvc;

        public CannotDeleteCashAcctIfTransactionsAttachedValidator(ICashAccountQueryService cashAcctQrySvc)
