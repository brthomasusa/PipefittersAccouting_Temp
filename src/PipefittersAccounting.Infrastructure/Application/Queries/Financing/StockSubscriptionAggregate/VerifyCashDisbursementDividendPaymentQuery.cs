...
namespace PipefittersAccounting.Infrastructure.Application.Queries.Financing.StockSubscriptionAggregate
{
    ...
    {
        public async static Task<OperationResult<VerifyCashDisbursementForDividendPayment>> Query(GetDividendDeclarationParameters queryParameters, DapperContext ctx)
        {
            try
            {
                var sql =
