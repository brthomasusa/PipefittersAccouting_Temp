...
namespace PipefittersAccounting.UI.HumanResources.Pages
{
    ...
    {
        public static ValueTask<IEnumerable<PayrollRegister>> GetPayrollRegisterAsync()
        {
            List<PayrollRegister> registers = new()
            {
                new PayrollRegister()
                {
            ...
            return new ValueTask<IEnumerable<PayrollRegister>>(registers);
        }

        public static List<PayrollRegister> GetPayrollRegister()
